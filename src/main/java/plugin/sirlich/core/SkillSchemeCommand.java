...
//                    rpgPlayer.tell("removed " + args[1]);
                    ...
                    try{
                        ...
                        rpgPlayer.addSkill(skillType,level, 0);
                ...
                if(args.length < 2){
                    WeaponUtils.giveLoadout(rpgPlayer,ClassType.FEET);
                    rpgPlayer.applySkillsFromArmor();
                    rpgPlayer.tell("Default applied. Specify like: " + Color.gray + "[h]ead, [b]reast, [l]egs, [f]eet");
                    return true;
                }
