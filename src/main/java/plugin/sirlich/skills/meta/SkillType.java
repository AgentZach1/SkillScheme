...
import plugin.sirlich.skills.clans.helmet.*;
import plugin.sirlich.skills.clans.chestplate.*;
// import plugin.sirlich.skills.clans.any.BreakFall;
import plugin.sirlich.skills.clans.leggings.*;
import plugin.sirlich.skills.clans.boots.*;
// import plugin.sirlich.skills.clans.paladin.*;
...
public enum SkillType {
    ...
    FlamingGrieves(new FlamingGrieves(null, 0)),
    ...
    Stomp(new Stomp(null, 0)),
    Placetto(new Placetto(null, 0)),
    Vigilance(new Vigilance(null, 0)),
    Consumption(new Consumption(null, 0));
