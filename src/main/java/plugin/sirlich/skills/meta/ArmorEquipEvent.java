...
public final class ArmorEquipEvent extends PlayerEvent implements Cancellable{
	 ...
	 * @param type The ArmorPiece of the armor added
	 * @param oldArmorPiece The ItemStack of the armor removed.
	 * @param newArmorPiece The ItemStack of the armor added.
	 */
	public ArmorEquipEvent(final Player player, final EquipMethod equipType, final ArmorPiece type, final ItemStack oldArmorPiece, final ItemStack newArmorPiece){
		super(player);
	...
	public final ArmorPiece getType(){
		return type;
	}
